...
heading_label=tk.Label(root,text="BLOOD MANAGEMENT SYSTEM",font=("Helvetica",20,"bold"),bg="#00296",fg="WHITE")
heading_label.pack(pady=20)
frame=tk.Frame(root,bg="#FDC500")
...
login_button = tk.Button(frame, text="Login", command=staff_login,bg="#f1111",fg="white")
