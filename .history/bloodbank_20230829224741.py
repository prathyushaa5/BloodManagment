...
bank_id_label.pack(row=0, column=0)
bank_id_entry.pack(row=0, column=1)
name_label.pack(row=1, column=0)
name_entry.pack(row=1, column=1)
capacity_label.pack(row=2, column=0)
capacity_entry.pack(row=2, column=1)
insert_button.pack(row=3, columnspan=2)
new_name_label.pack(row=4, column=0)
new_name_entry.pack(row=4, column=1)
new_capacity_label.pack(row=5, column=0)
new_capacity_entry.pack(row=5, column=1)
update_button.pack(row=6, columnspan=2)
delete_button.pack(row=7, columnspan=2)
