...
def option():
    ...
    a_button=tk.Button(frame,text="Address ",command=address)
    b_button=tk.Button(frame,text="BloodType",command=blood_type)
    d_button=tk.Button(frame,text="Donor",command=donor)
    r_button=tk.Button(frame,text="Recipient ",command=recipient)
    g_button=tk.Button(frame,text="Gives_To ",command=gives_to)
    t_button=tk.Button(frame,text="Takes_from ",command=takes_from)
    ...
    t_button.grid(row=0,column=2,padx=10,pady=10)
...
# Labels and Entry fields for Address
   Address_ID_label = tk.Label(frame, text="Address ID:")
   City_label = tk.Label(frame, text="City:")
   District_label = tk.Label(frame, text="District:")
   Neighborhood_label = tk.Label(frame, text="Neighborhood:")
   Address_ID_entry = tk.Entry(frame)
   City_entry = tk.Entry(frame)
   District_entry=tk.Entry(frame)
   Neighborhood_entry = tk.Entry(frame)
   new_City_label = tk.Label(frame, text="New City:")
   new_District_label = tk.Label(frame, text="New District:")
   new_Neighborhood_label = tk.Label(frame, text="New Neighborhood:")
...
def blood_type():
  ...
  #       address()
   ...
   # Create the GUI window
   root = tk.Tk()
   root.title("Blood Type Display")window_width=600
   window_height=400
   frame=tk.Frame(root)
   frame.place(relx=0.5,rely=0.5,anchor="center")
   root.geometry(f"{window_width}x{window_height}")
...
# Labels and Entry fields for Donor
    ...
    Blood_ID_label = tk.Label(frame, text="Blood ID:")
    Address_ID_label = tk.Label(frame, text="Address ID:")
    ...
    Address_ID_entry = tk.Entry(frame)
    new_First_Name_label = tk.Label(frame, text="New First Name:")
    new_Last_Name_label = tk.Label(frame, text="New Last Name:")
    new_First_Name_label = tk.Label(frame, text="New First Name:")
    new_Address_ID_label = tk.Label(frame, text="New Address_ID:")
...
# Grid layout for Donor
    ...
    Last_Name_entry.grid(row=2,column=0)
    Blood_ID_label.grid(row=3,column=0)
    Blood_ID_entry.grid(row=3,column=0)
    Address_ID_label.grid(row=4,column=0)
    Address_ID_entry.grid(row=4,column=0)
    insert_button.grid(row=5,column=0)
    new_First_Name_label.grid(row=6,column=0)
    new_First_Name_entry.grid(row=6,column=0)
    new_Last_Name_label.grid(row=7,column=0)
    new_Last_Name_entry.grid(row=7,column=0)
    new_Address_ID_label.grid(row=8,column=0)
    new_Address_ID_entry.grid(row=8,column=0)
    update_button.grid(row=9,column=0)
    delete_button.grid(row=9,column=1)
    display_button.grid(row=10,column=1,columnspan=3)
    result_text.grid(row=11)
    # previous_button.grid(row=14,column=0,columnspan=1)
    done_button.grid(row=12,column=1)
...
# Grid layout for Recipient
  ...
  new_Address_ID_label.pack()
  new_Address_ID_entry.pack()
  new_Phone_No_label.pack()
  new_Phone_No_entry.pack()
  update_button.pack()
  delete_button.pack()
  display_button.pack()
  result_text.pack()
...
# Grid layout for updating
  new_Name_label.pack()
  new_Name_entry.pack()
  new_Capacity_label.pack()
  new_Capacity_entry.pack()
  update_button.pack()
