...
# Labels and Entry fields for Address
   Address_ID_label = tk.Label(frame, text="Address ID:",bg="#03045e")
   City_label = tk.Label(frame, text="City:",bg="#03045e")
   District_label = tk.Label(frame, text="District:",bg="#03045e")
   Neighborhood_label = tk.Label(frame, text="Neighborhood:",bg="#03045e")
   Address_ID_entry = tk.Entry(frame)
   City_entry = tk.Entry(frame)
   District_entry=tk.Entry(frame)
   Neighborhood_entry = tk.Entry(frame)
   new_City_label = tk.Label(frame, text="New City:",bg="#03045e")
   new_District_label = tk.Label(frame, text="New District:",bg="#03045e")
   new_Neighborhood_label = tk.Label(frame, text="New Neighborhood:",bg="#03045e")
