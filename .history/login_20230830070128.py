...
username_label = tk.Label(frame, text="Username:",background="lightgray")
password_label = tk.Label(frame, text="Password:",background="lightgray")
message_label = tk.Label(frame, text="", fg="black",background="lightgray")

username_entry = tk.Entry(frame)
password_entry = tk.Entry(frame, show="*")

login_button = tk.Button(frame, text="Login", command=staff_login)
