...
heading_label=tk.Label(root,text="BLOOD MANAGEMENT SYSTEM",font=("Helvetica",20,"bold"),fg="WHITE")
...
login_button = tk.Button(frame, text="Login", command=staff_login,bg="#fdc500")
