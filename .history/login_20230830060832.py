...
login_button = tk.Button(root, text="Login", command=staff_login)
    ...
    # Layout using grid
username_label.grid(row=2,column=0,columnspan=3,padx=10,pady=10)
username_entry.grid(row=2,column=1,columnspan=3,padx=10,pady=10)
password_label.grid(row=4,column=0,columnspan=3,padx=10,pady=10)
password_entry.grid(row=4,column=1,columnspan=3,padx=10,pady=10)
login_button.grid(row=6,column=1,columnspan=2,pady=10)
