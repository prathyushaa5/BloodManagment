...
#         root.destroy()
#         blood_type()
#     next_button=tk.Button(root,text="Next",command=next,padx=10, pady=10)
#     previous_button=tk.Button(root,text="prev",command=previous,padx=10, pady=10)
