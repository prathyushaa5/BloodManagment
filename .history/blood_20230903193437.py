...
def option():
    ...
    bg_image=PhotoImage(file="donor.png")
    background_label=tk.Label(root,image=bg_image)
    background_label.place(relwidth=0.5,relheight=0.5)
    frame=tk.Frame(root,borderwidth=5,relief="solid",highlightthickness=0.5,highlightbackground="white",bg="white")
    frame.place(relx=0.5,rely=0.5,anchor="center")
    heading_label=tk.Label(root,text="MENU",font=("Comic Sans MS",12,"bold"),bg="#006D77",fg="WHITE")
