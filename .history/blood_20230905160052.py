...
def option():
    ...
    e_button=tk.Button(frame,text="Exit",command=exit_program,fg="white",bg="blue")
    ...
    e_button.grid(row=8,column=2,padx=10,pady=10)
    def exit_program():
...
# Labels and Entry fields for updating
  new_Name_label = tk.Label(frame, text="New Name:",bg="#caf0f8")
  new_Capacity_label = tk.Label(frame, text="New Capacity:",bg="#caf0f8")
