  ...
  def insert_recipient():
    ...
    if count1>0 and count2>0:
        ...
        if count3>0:
           ...
           query = "INSERT INTO Recipent(Recipient_ID,First_Name, Last_Name, Blood_ID, Address_ID, Phone_No) VALUES (%s, %s, %s, %s, %s)"
...
# Grid layout for Recipient
  ...
  new_Blood_ID_label.grid(row=9,column=0)
  new_Blood_ID_entry.grid(row=9,column=1)
  new_Address_ID_label.grid(row=10,column=0)
  new_Address_ID_entry.grid(row=10,column=1)
  new_Phone_No_label.grid(row=11,column=0)
  new_Phone_No_entry.grid(row=11,column=1)
