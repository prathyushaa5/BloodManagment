...
def display_donor_details():
    ...
    for donor in donor_data:
        result_text.insert(END, f"ID: {donor[0]}, First Name: {donor[1]}, Last Name: {donor[2]}, Blood ID: {donor[3]}, Address ID: {donor[4]}\n")    
...
display_button = Button(root, text="Display Donor Details", command=display_donor_details)
...
display_button.grid(row=12, column=0, pady=10)
