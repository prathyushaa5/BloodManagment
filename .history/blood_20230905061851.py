...
def blood_type():
   ...
   window_width=600
   window_height=400
   frame=tk.Frame(root,borderwidth=1,relief="flat",highlightthickness=0.5,highlightbackground="white",bg="#C0C0C0")
   frame.place(relx=0.5,rely=0.5,anchor="center")
   root.geometry(f"{window_width}x{window_height}")
...
# Delete data from Donor table
   ...
   # Create the GUI window
    ...
    window_height=600
    root.geometry(f"{window_width}x{window_height}")
    frame=tk.Frame(root,borderwidth=5,relief="flat",highlightthickness=0.5,highlightbackground="white",bg="#C0C0C0")
    frame.place(relx=0.5,rely=0.5,anchor="center")
...
# Labels and Entry fields for Donor
    ...
    Phone_No_label=tk.Label(frame,text="Phone_No:",bg="#C0C0C0")
...
# Labels and Entry fields for Blood_bank
  ...
  Name_label = tk.Label(frame, text="Name:",bg="#C0C0C0")
  Capacity_label = tk.Label(frame, text="Capacity:",bg="#C0C0C0")
  Bank_ID_entry = tk.Entry(frame,bg="#C0C0C0")
  Name_entry = tk.Entry(frame,bg="#C0C0C0")
  Capacity_entry = tk.Entry(frame,bg="#C0C0C0")
...
# Labels and Entry fields for Takes_from
  Transfer_ID_label = tk.Label(frame, text="Transfer ID:")
  Recipient_ID_label = tk.Label(frame, text="Recipient ID:")
  Bank_ID_label = tk.Label(frame, text="Bank ID:")
  Amount_label = tk.Label(frame, text="Amount:")
  ...
  Bank_ID_entry = tk.Entry(frame)
  Amount_entry = tk.Entry(frame)
  new_Amount_label = tk.Label(frame, text="New Amount:")
  new_Amount_entry = tk.Entry(frame)
