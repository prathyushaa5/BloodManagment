...
# Labels and Entry fields for Address
   Address_ID_label = tk.Label(frame, text="Address ID:",bg="#98C1D9")
   City_label = tk.Label(frame, text="City:",bg="#98C1D9")
   District_label = tk.Label(frame, text="District:",bg="#98C1D9")
   Neighborhood_label = tk.Label(frame, text="Neighborhood:",bg="#98C1D9")
   Address_ID_entry = tk.Entry(frame)
   City_entry = tk.Entry(frame)
   District_entry=tk.Entry(frame)
   Neighborhood_entry = tk.Entry(frame)
   new_City_label = tk.Label(frame, text="New City:",bg="#98C1D9")
   new_District_label = tk.Label(frame, text="New District:",bg="#98C1D9")
   new_Neighborhood_label = tk.Label(frame, text="New Neighborhood:",bg="#98C1D9")
