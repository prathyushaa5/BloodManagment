...
# Labels and Entry fields for gives_to
  Donation_ID_label = tk.Label(frame, text="Donation ID:",bg="#caf0f8")
  Donor_ID_label = tk.Label(frame, text="Donor ID:",bg="#caf0f8")
  Bank_ID_label = tk.Label(frame, text="Bank ID:",bg="#caf0f8")
  Amount_label = tk.Label(frame, text="Amount:",bg="#caf0f8")
  new_Amount_label = tk.Label(frame, text="New Amount (for update):",bg="#caf0f8")
...
# Buttons for Takes_from
  insert_button = tk.Button(frame, text="Insert", command=insert_takes_from)
  delete_button = tk.Button(frame, text="Delete", command=delete_takes_from)
  display_button = tk.Button(frame, text="Display", command=display_takes_from)
  update_button = tk.Button(frame, text="Update", command=update_takes_from)
  next_button=tk.Button(frame,text="Next",command=next)
