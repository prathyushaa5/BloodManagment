...
# Create the GUI window
   ...
   window_height=600
   root.geometry(f"{window_width}x{window_height}")
   root.configure(bg="#adc178")
   heading_label=tk.Label(root,text="ADDRESS",font=("Serif",15,"bold"),bg="#adc178",fg="WHITE")
   heading_label.pack(pady=20)
   frame=tk.Frame(root,borderwidth=5,relief="flat",highlightthickness=0.5,highlightbackground="#73956f",bg="#dde5b6")
   frame.place(relx=0.5,rely=0.5,anchor="center")
