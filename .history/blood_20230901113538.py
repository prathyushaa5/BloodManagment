...
def option():
    ...
    a_button=tk.Button(root,text="Address ",command=address)
    b_button=tk.Button(root,text="BloodType",command=blood_type)
    d_button=tk.Button(root,text="Donor",command=donor)
    r_button=tk.Button(root,text="Recipient ",command=recipient)
    g_button=tk.Button(root,text="Gives_To ",command=gives_to)
    t_button=tk.Button(root,text="Takes_from ",command=takes_from)
    t_button.grid(row=0,column=0)
    a_button.grid(row=0,column=1)
    b_button.grid(row=1,column=0)
    d_button.pack(row=1,column=1)
    r_button.pack(row=2,column=0)
    g_button.pack(row=2,column=1)
