...
def option():
    ...
    a_button=tk.Button(root,text="Address        ",command=address,padx=20,pady=10)
    a_button.grid(row=0,column=1,columnspan=3)
    b_button=tk.Button(root,text="BloodType      ",command=blood_type,padx=20,pady=10)
    b_button.grid(row=1,column=1,columnspan=3)
    d_button=tk.Button(root,text="Donor          ",command=donor,padx=20, pady=10)
    d_button.grid(row=2,column=1,columnspan=3)
    r_button=tk.Button(root,text="Recipient      ",command=recipient,padx=20, pady=10)
    r_button.grid(row=3,column=1,columnspan=3)
    g_button=tk.Button(root,text="Gives_To       ",command=gives_to,padx=20,pady=10)
    g_button.grid(row=4,column=1,columnspan=3)
    t_button=tk.Button(root,text="Takes_from     ",command=takes_from,padx=20,pady=10)
    t_button.grid(row=5,column=1,columnspan=3)
