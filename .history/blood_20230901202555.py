...
def option():
    root=tk.Tk(bg="#00296B") 
    window_width=600
    window_height=400
    frame=tk.Frame(root,borderwidth=2,relief="solid",highlightthickness=1,highlightbackground="white",bg="#4B4BC3")
...
# Labels and Entry fields for Recipient
  ...
  Blood_ID_label = tk.Label(frame, text="Blood ID:")
  Address_ID_label = tk.Label(frame, text="Address ID:")
  Phone_No_label = tk.Label(frame, text="Phone No:")
